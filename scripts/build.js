...
const {writeThemesFile, writeErrorFile, writeStatichuntFile} = require('./build/write')
// const {generateStatichuntData} = require('./build/statichunt')
...
const build = async (options) => {
    ...
    // if (options.statichunt) {
    //     // Updates statichunt.json
    //     const statichunt = generateStatichuntData(themesMarkdown)
    //     writeStatichuntFile(statichunt);
    // }
