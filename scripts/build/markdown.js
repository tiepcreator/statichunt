...
const loadThemeFrontMatter = absFilename => {
  ...
  const frontmatter = yamlFront.loadFront(fileData);
    ...
    let product = frontmatter.product;
...
// const themeData= config.themesMarkdownFiles;
// for (let i = 0; i < themeData.length; i++) {
//   let themeCheck = loadThemeFrontMatter(themeData[i])
//   if (themeCheck.product) {
//     console.log("Premium")
//   } else if (themeCheck.github) {
//     console.log("free")
//   }
// }
